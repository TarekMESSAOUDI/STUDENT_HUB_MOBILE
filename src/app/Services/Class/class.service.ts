...
export class ClassService {
  ...
  addClass(classe: any, id: any, idU: any): Observable<any> {
    return this.classhttp.post<any>(this.baseUrl + '/addClass/' + id + '/' + idU, classe);
  }
  ...
  getClassByUniversiteId(id: any): Observable<any> {
    return this.classhttp.get(this.baseUrl + '/getClassByUniversiteId/' + id);
  }
}
