...
export class SeanceService {
  ...
  getBySeanceIdEnsignant(id: any): Observable<any> {
    return this.seancehttp.get(this.baseURL + 'getByIdEnseignant/' + id);
  }

  deleteSeance(id: any): Observable<any> {
    return this.seancehttp.delete(this.baseURL + 'deleteSeance/' + id);
  }
}
